...
Prepare a fresh hash-locked root from the most recent 62 x 2160 case::
    ...
    python scripts/run_compact_fullseason.py --run-root runs/road_joint_v2/COMPACT_50M --action prepare

Run/resume the dependency-safe four-worker schedule::

    python scripts/run_compact_fullseason.py --run-root runs/road_joint_v2/COMPACT_50M --action run

Watch evidence-based progress from another terminal::

    python scripts/run_compact_fullseason.py --run-root runs/road_joint_v2/COMPACT_50M --action status --watch
"""
...
from competition.road_joint_v2.builder import load_case
