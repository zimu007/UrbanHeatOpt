...
from urbanheatopt.data.adapters.guanggu_v03 import (
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "",
            "```powershell",
            "conda run --no-capture-output -n urbanheatopt_env python tools/legacy_cli/validate_inputs.py `",
            ...
            "",
            "```powershell",
            "conda run --no-capture-output -n urbanheatopt_env python tools/legacy_cli/run_case.py `",
            f"  --delivery-root \"{source}\" `",
            "  --source-profile guanggu_v03 `",
            "  --profile v1-full",
            "```",
