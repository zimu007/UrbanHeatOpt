...
``urbanheatopt.model.road_version.compact``; this file is responsible only for
...
from urbanheatopt.optimization.pareto import ParetoPoint, ParetoSpec, assemble_pareto_run
...
from urbanheatopt.optimization.solvers import SolverSettings, get_solver_evidence, solve_pyomo_model


REPOSITORY = REPOSITORY_ROOT_PATH
...
def compact_mathematics_hashes() -> dict[str, str]:
    ...
    relative_paths = (
        ...
        "src/urbanheatopt/optimization/pareto.py",
        "src/urbanheatopt/optimization/solvers.py",
        "src/urbanheatopt/data/road_builder.py",
        "src/urbanheatopt/model/compact.py",
        "src/urbanheatopt/optimization/compact_tasks.py",
        "src/urbanheatopt/qa/road_results.py",
        "tools/legacy_cli/run_compact_fullseason.py",
    )
    result: dict[str, str] = {}
...
def create_compact_plan(
    ...
    *,
    ...
    from urbanheatopt.model.compact import build_compact_tree_designs
...
def _design_for_task(case: Any, plan: dict[str, Any], task: dict[str, Any]) -> Any:
    from urbanheatopt.model.compact import CompactChain, CompactTreeDesign
...
def run_compact_task(root: str | Path, task_id: str) -> ParetoPoint | None:
    ...
    from urbanheatopt.model import compact as compact_module
