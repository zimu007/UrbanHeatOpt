...
from urbanheatopt.data.canonical import CanonicalCaseData
from urbanheatopt.model.reference_core import CoreModelInput, CoreSolveResult, build_core_model
