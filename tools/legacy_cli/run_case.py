...
from urbanheatopt.optimization.pipelines import (
    run_case_pipeline,
    run_guanggu_v03_pipeline,
    run_wuhan_v02_pipeline,
)
from urbanheatopt.data.adapters.wuhan_v02_case import WuhanV02CaseError
from urbanheatopt.data.adapters.guanggu_v03_case import GuangguV03CaseError
from urbanheatopt.data.readiness import (
    default_audit_output_dir,
    default_guidance_report_path,
    run_guanggu_v03_input_validation,
)
from urbanheatopt.data.validation.v3_inputs import V3InputError
...
def main() -> int:
    ...
    try:
        if args.core_version == "road_joint_v2":
            ...
            from urbanheatopt.data.reference_road_pipeline import prepare_delivery
            from urbanheatopt.optimization.reference_tasks import run_task
            try:
